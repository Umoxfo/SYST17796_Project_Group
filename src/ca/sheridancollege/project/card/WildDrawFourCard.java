 ...
 * and also the next player has to draw 4 cards as their turn.</p>
 *
 * <p>It may legally play only if the player has a matching card. If you play this card illegally,
 * the other player may challenge you to show your hand. If guilty, you must draw 4 cards.
 * If the challenged player is innocent, the challenger must draw 6 cards.</p>
 *
 * <p>At the beginning of the play, return this card to the Draw pile, shuffle, and turn up a new one.</p>
 * <br>
 *
...
public class WildDrawFourCard extends WildCard implements DrawCard {
    ...
    public void showMessage() {
        Message.stdPrintf("draw.card.the.next.player.must.draw.cards.and.lose.their.turn", DRAW_FOUR);
    }
}
